...
(function () {
  ...
  function campingTotals(f) {
    ...
    return {
      ...
      mealsCost: mealsCost, guideCost: guideCost, jeepCost: jeepCost,
      foodLines: foodLines, foodCost: foodCost,
      grandTotal: tentCost + mealsCost + guideCost + jeepCost + foodCost
    };
  }
  ...
  function App() {
    ...
    var campingState = useState({ adults: 2, children: 0, childAges: [], tents: 1, meals: "no", jeep: "no", foodQty: {} });
